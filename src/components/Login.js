...
export function Login() {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      setError("We have sent you an email with reset password")
    } catch (error) {
      setError(error.message);
    }
  };
  ...
  return (
    <div className="w-full max-w-xs m-auto">
      ...
      <button
        ...
        className="bg-slate-50 hover:bg-slate-200 text-black shadow-md rounded border-2 border-gray-300 px-4 w-full"
      >
        Google Login
      </button>
    </div>
